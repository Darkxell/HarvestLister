...
public class CommandHelp extends DiscordBotCommand {
	...
	public void process(MessageReceivedEvent event) {
		...
		String message1 = "Hi " + event.getAuthor().getName() + ",\r\n" + "\r\n"
				...
				+ "\r\n" + "```USAGE```\r\n" + "> h! list <poe.trade search id> (filter)\r\n"
				...
				+ "\r\n" + "Filters are optional, but can allow you to more appropriately list your trades.\r\n"
				+ "The possible values are:\r\n"
				+ "**DEFAULT**  Will only show the main valuable craft categories. This already includes almost everything.\r\n"
				+ "**FINE** Will also show \"remove-non#\" and\"randomize\" crafts. This is only worth doing if you have lots of them for sale.\r\n"
				+ "**FINER** Will also show reforge crafts. You probably shouldn't use this.\r\n"
				+ "**ALL** Disables the filter for extremely low value crafts, and crafts that can't be traded. Avoid this in public channels.\r\n"
